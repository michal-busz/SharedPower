...
class StrtLoginPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        #TODO REMOVE !!! and remove from entries below
        log = tk.StringVar()
        log.set("login2")
        pas = tk.StringVar()
        pas.set("password")
        ...
        self.password_entry=tk.Entry(self,
                            font=controller.entry_height,
                            width="34",show="*", textvariable=pas)
        ...
        login_button=tk.Button(self,
                            ...
                            fg="white",
                            width="8",
                            relief=tk.RIDGE,command=self.call_to_login_succed).grid(row=6,sticky="W",padx=45,pady=(10,2))
        ...
        Available_Tools_buton=tk.Button(self,
                            ...
                            bg=controller.button_color,
                            fg="white",
                            relief=tk.RIDGE,command=self.show_available_tools).grid(row=8,padx=40,pady=(0,10),sticky="nsew")
...
class RegisterPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        Registration_button=tk.Button(self,
                            ...
                            fg="white",
                            width="8",
                            relief=tk.RIDGE,command=self.registration_command).grid(row=7,sticky="W",pady=(35,2),padx=(46,0))
        ...
        reg_to_login_button=tk.Button(self,
                            ...
                            bg=controller.button_color,
                            fg="white",
                            relief=tk.RIDGE,command=self.regispage_page_to_login).grid(row=8,column=0,columnspan=2,pady=(48,0))
        ### This function load some thing after window is opened
