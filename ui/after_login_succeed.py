...
class Login_Succeed(tk.Tk):
	...
	### Define Usefull Variables
        ...
        for F in (Login_succed_main_page,Available_tool_win,
                  Offered_tool_win,Hired_tool_win,Edit_profile_win,Offer_new_tool_win,Invoces_window, Specific_tool_detail_win, Return_requested_window):
...
class Login_succed_main_page(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        menu_bg_color=tk.Label(self,font=controller.menu_buton_font,width="105",height="1").grid(row=1,column=0,columnspan=7,sticky="nsew")
        ...
        menu_bg_color=tk.Label(self,font=controller.menu_buton_font,height="4",bg=controller.bar_color).grid(row=9,column=0,columnspan=7,sticky="nsew")
    ...
    def signout_func(self):
        ...
        if MsgBox =="yes":
            ...
            from ui.full_login_and_regis import func_login_page
            func_login_page()
...
class Offer_new_tool_win(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        menu_bg_colors=tk.Label(self,font=controller.menu_buton_font,width="105",bg=controller.bar_color,height="3").grid(row=0,column=0,columnspan=7,sticky="nsew")
        tk.Label(self,font=controller.menu_buton_font,bg=controller.bg_color,height="10").grid(pady=(16,0),padx=20,row=1,column=0,columnspan=7,rowspan=8,sticky="nsew")
        ...
        menu_bg_color=tk.Label(self,font=controller.menu_buton_font,height="4",bg=controller.bar_color).grid(pady=(23,0),row=9,column=0,columnspan=7,sticky="nsew")
    ...
    def isDetailsValid(self):
        ...
        try:
            ...
            if tool.str_to_date(date) < (datetime.date.today()+ datetime.timedelta(6*7)) and tool.str_to_date(date) > datetime.date.today():
                cond2 = True
        except ValueError:
            return False
    ...
    def upload_img(self):
        self.img_filename = tk.filedialog.askopenfilename(initialdir = "/",title = "Select Image",filetypes = (("jpeg files","*.jpg"),("all files","*.*")))
...
class Edit_profile_win(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Label(self,text="New Full Name* :",
                            font=controller.norml_font,bg="#e6e6e6").grid(row=2,column=0,columnspan=3,sticky="e",pady=(15,0),padx=(0,20))
        tk.Label(self,text="New Email* :",
                            font=controller.norml_font,bg="#e6e6e6").grid(row=3,column=0,columnspan=3,sticky="e",pady=(15,0),padx=(0,20))
        tk.Label(self,text="New Password* :",
                            font=controller.norml_font,bg="#e6e6e6").grid(row=4,column=0,columnspan=3,sticky="e",pady=(15,0),padx=(0,20))
        tk.Label(self,text="New Bill Addr* :",
                            font=controller.norml_font,bg="#e6e6e6").grid(row=5,column=0,columnspan=3,sticky="e",pady=(15,0),padx=(0,20))
        ...
        menu_bg_color=tk.Label(self,font=controller.menu_buton_font,height="4",bg=controller.bar_color).grid(pady=(13,0),row=9,column=0,columnspan=7,sticky="nsew")
    ...
    def fill_details(self):
        ...
        self.new_BillAddr_entry = tk.Entry(self,
                                           font=self.controller.sml_entry_height, width="28", textvariable=self.newBAddress)
        self.new_BillAddr_entry.grid(row=5, column=3, columnspan=3, sticky="w", pady=(15, 15))
        self.new_Password_entry = tk.Entry(self,
                                           font=self.controller.sml_entry_height, width="28", textvariable=self.newPassword)
        ...
        self.new_fulname_entry = tk.Entry(self,
                                          font=self.controller.sml_entry_height, width="28", textvariable=self.newFullName)
...
class Invoces_window(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        ### Code for Offer_new_tool_win
        tk.Label(self,font=controller.menu_buton_font,width="105",bg=controller.bar_color,height="3").grid(row=0,column=0,columnspan=7,sticky="nsew")
        tk.Label(self,font=controller.menu_buton_font,bg=controller.bg_color,height="10").grid(pady=(16,0),padx=20,row=1,column=0,columnspan=7,rowspan=5,sticky="nsew")
...
##        self.Invoice_mesg_box.config(state=tk.DISABLED)
        ...
        ### Footer
        menu_bg_color=tk.Label(self,font=controller.menu_buton_font,height="4",bg=controller.bar_color).grid(pady=(10,0),row=6,column=0,columnspan=7,sticky="nsew")
...
class Hired_tool_win(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Label(self,font=controller.menu_buton_font,width="105",bg=controller.bar_color,height="3").grid(row=0,column=0,columnspan=7,sticky="nsew")
        tk.Label(self,font=controller.menu_buton_font,bg=controller.bg_color,height="10").grid(pady=(8,0),padx=20,row=1,column=0,columnspan=7,rowspan=5,sticky="nsew")
        go_back_butn=tk.Button(self,
                            text="Go Back",
                            bd=2,
                            font=controller.back_btn_fnt,
        ...
        view_Tool_btn = tk.Button(self, text="View tool's details",
                                    ...
                                    bg=controller.button_color,
                                    fg="white",
                                    relief=tk.RIDGE, command=self.showDetails) #TODO add command
        view_Tool_btn.grid(pady=5, row=5, column=0, columnspan=7, sticky="e", padx="100")

        menu_bg_color=tk.Label(self,font=controller.menu_buton_font,height="4",bg=controller.bar_color).grid(pady=(18,0),row=6,column=0,columnspan=7,sticky="nsew")
    ...
    def generateTree(self):
        ...
        for x in data.current_user.hired_tools:
            if x.details['is_return_accepted'] == True:
                self.tree.insert('', 'end', values=[str(x.details['name']), str(x.details['price']), str(x.details['location'])], tags = ('returned'))
            elif x.details['return_date'] != None:
                self.tree.insert('', 'end', values=[str(x.details['name']), str(x.details['price']), str(x.details['location'])], tags = ('requested'))
            else:
                self.tree.insert('', 'end', values=[str(x.details['name']), str(x.details['price']), str(x.details['location'])], tags=('hired'))
                ...
                if MsgBox =="yes":
                    ...
                    for x in data.current_user.available_tools:
                        if x.details['name'] == self.tree2.item(selected)['values'][0]:
                            ...
                            x.hire_tool(data.current_user.id, date, self.half_day.get(), self.transportTo.get(),self.tranportFrom.get())
...
class Offered_tool_win(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        ### Footer
        menu_bg_color=tk.Label(self,font=controller.menu_buton_font,height="4",bg=controller.bar_color).grid(pady=(27,0),row=6,column=0,columnspan=7,sticky="nsew")
    ...
    def generateTree(self):
        ...
        for x in data.current_user.offered_tools:
            if x.details['return_date'] == None and x.details['is_hired'] == True:
                self.tree.insert('', 'end', values=[str(x.details['name']), str(x.details['price']), str(x.details['location'])], tags = ('hired'))
            elif x.details['return_date'] != None and x.details['is_return_accepted'] == None and x.details['is_hired'] == True:
                self.tree.insert('', 'end', values=[str(x.details['name']), str(x.details['price']), str(x.details['location'])], tags = ('requested'))
                self.requested.append(x)
            elif x.details['is_return_accepted'] == False:
                self.tree.insert('', 'end', values=[str(x.details['name']), str(x.details['price']), str(x.details['location'])], tags=('damaged'))
